...
public class OreControlUtilTest {
    ...
    public void GetOreSettings_When_OneArgumentIsNull_Expect_ThrowNullPointerException() {
        assertThrows(NullPointerException.class, () -> OreControlUtil.getOreSettings(null, mock(WorldOreConfig.class), Biome.BADLANDS));
        assertThrows(NullPointerException.class, () -> OreControlUtil.getOreSettings(Ore.GOLD, mock(WorldOreConfig.class), null));
        assertThrows(NullPointerException.class, () -> OreControlUtil.getOreSettings(Ore.GOLD, null, Biome.BADLANDS));
    }
    ...
    public void GetOreSettings_When_BiomeOreSettingsAndOreSettingsExists_Expect_ReturnTheOreSettings() {
        ...
        for (Biome biome : Biome.values()) {
            ...
            for (Ore ore : biome.getOres()) {
                final OreSettings oreSettings = new OreSettingsYamlImpl(ore);
                oreSettingsSet.add(oreSettings);
                biomeOreSettings.setOreSettings(oreSettings);
            }
        }

        final Iterator<OreSettings> oreSettingsIterator = oreSettingsSet.iterator();

        for (Biome biome : Biome.values())
            for (Ore ore : biome.getOres())
                assertSame(OreControlUtil.getOreSettings(ore, worldOreConfig, biome), oreSettingsIterator.next());
    }

    @Test
    public void GetOreSettings_When_BiomeOreSettingsNotExistsButNormalOne_Expect_ReturnNormalOreSetting() {
        final WorldOreConfig worldOreConfig = new WorldOreConfigYamlImpl("dummy", false);
        ...
        for (Biome biome : Biome.values())
            for (Ore ore : biome.getOres())
                assertSame(OreControlUtil.getOreSettings(ore, worldOreConfig, biome), worldOreConfig.getOreSettings(ore).get());
    }

    @Test
    public void GetOreSettings_When_BiomeOreSettingsAndNormalOreSettingsExistButBiomeSpecificOreSettingNot_Expect_ReturnNormalOreSetting() {
        final WorldOreConfig worldOreConfig = new WorldOreConfigYamlImpl("dummy", false);
    ...
    @Test
    public void GetOreSettings_When_OnlyBiomeOreSettingsExists_Expect_ReturnDefaultOreSetting() {
        final WorldOreConfig worldOreConfig = new WorldOreConfigYamlImpl("dummy", false);
        ...
        for (Biome biome : Biome.values())
            for (Ore ore : biome.getOres())
                assertEquals(OreControlUtil.getOreSettings(ore, worldOreConfig, biome), OreControl.getInstance().getSettings().getDefaultSettings(ore));
    }

    @Test
    public void GetOreSettings_When_NoBiomeOreSettingsOrOreSettingsExists_Expect_ReturnDefaultOreSetting() {
        final WorldOreConfig worldOreConfig = new WorldOreConfigYamlImpl("dummy", false);
    ...
    @Test
    public void GetOreSettings_When_BiomeDontHaveTheOre_Expect_ThrowIllegalArgumentException() {
        final WorldOreConfig worldOreConfig = new WorldOreConfigYamlImpl("dummy", false);
        ...
        for (Biome biome : Biome.values()) {
            ...
            for (Ore ore : ores)
                assertThrows(IllegalArgumentException.class, () -> OreControlUtil.getOreSettings(ore, worldOreConfig, biome));
        }
    }
