package de.derfrzocker.feature.impl.v26_1_base.feature.generator;
...
public class OreConfigurationGenerator extends MinecraftFeatureGenerator<OreConfiguration, OreFeatureConfiguration> {
        ...
        return new Parser<>() {
            ...
            public JsonElement toJson(OreFeatureConfiguration value) {
                ...
                if (value.getSize() != null) {
                    JsonObject size = value
                            .getSize()
                            .getValueType()
                            .getParser()
                            .toJson(value.getSize())
                            .getAsJsonObject();
                ...
                if (value.getDiscardChanceOnAirExposure() != null) {
                    JsonObject discardChanceOnAirExposure = value
                            .getDiscardChanceOnAirExposure()
                            .getValueType()
                            .getParser()
                            .toJson(value.getDiscardChanceOnAirExposure())
                            .getAsJsonObject();
                    discardChanceOnAirExposure.addProperty(
                            "discard_chance_on_air_exposure_type",
                            value
                                    .getDiscardChanceOnAirExposure()
                                    .getValueType()
                                    .getKey()
            ...
            public OreFeatureConfiguration fromJson(JsonElement jsonElement) {
                ...
                if (jsonObject.has("targets")) {
                    ...
                    targetValues = registries
                            .getValueTypeRegistry(TargetListType.class)
                            .get(NamespacedKey.fromString(targets.getAsJsonPrimitive("target_type").getAsString()))
                            .get()
                            .getParser()
                            .fromJson(targets);
                }
                ...
                if (jsonObject.has("size")) {
                    ...
                    size = registries
                            ...
                            .get(NamespacedKey.fromString(sizes.getAsJsonPrimitive("size_type").getAsString()))
                            .get()
                            .getParser()
                            .fromJson(sizes);
                }
                ...
                if (jsonObject.has("discard_chance_on_air_exposure")) {
                    ...
                    discardChanceOnAirExposure = registries
                            .getValueTypeRegistry(FloatType.class)
                            .get(NamespacedKey.fromString(chance
                                                                  .getAsJsonPrimitive(
                                                                          "discard_chance_on_air_exposure_type")
                                                                  .getAsString()))
                            .get()
                ...
                return new OreFeatureConfiguration(
                        OreConfigurationGenerator.this,
                        targetValues,
                        size,
    ...
    public OreFeatureConfiguration mergeConfig(OreFeatureConfiguration first, OreFeatureConfiguration second) {
        return new OreFeatureConfiguration(
                ...
                first.getDiscardChanceOnAirExposure() !=
                null ? first.getDiscardChanceOnAirExposure() : second.getDiscardChanceOnAirExposure());
    }
