package de.derfrzocker.feature.impl.v26_1_base.placement;
...
public abstract class MinecraftPlacementModifier<M extends PlacementModifier, C extends PlacementModifierConfiguration>
        implements FeaturePlacementModifier<C> {
    ...
    public abstract M createPlacementModifier(
    ...
    @NotNull
    @Override
    public Stream<BlockVector> getPositions(
            @NotNull WorldInfo worldInfo,
            @NotNull Random random,
            @NotNull BlockVector position,
            @NotNull LimitedRegion limitedRegion,
        ...
        return placementModifier
                .getPositions(
                        new PlacementContext(
                                level,
                                level.getMinecraftWorld().getChunkSource().getGenerator(),
                                Optional.empty()),
                        new RandomSourceWrapper(random),
                        new BlockPos(position.getBlockX(), position.getBlockY(), position.getBlockZ())).
