package de.derfrzocker.feature.impl.v26_1_base.value.offset;
...
public class NMSBelowTopOffsetIntegerValue extends BelowTopOffsetIntegerValue {
    ...
    public Integer getValue(
        ...
        return Math.min(level.getHeight(), chunkGenerator.getGenDepth()) - 1 +
               Math.max(level.getMinY(), chunkGenerator.getMinY()) - baseValue;
    }
