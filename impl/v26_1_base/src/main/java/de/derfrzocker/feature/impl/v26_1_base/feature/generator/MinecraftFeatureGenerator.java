...
public abstract class MinecraftFeatureGenerator<M extends FeatureConfiguration, C extends FeatureGeneratorConfiguration>
        implements FeatureGenerator<C> {
    ...
    public abstract M createConfiguration(
