package de.derfrzocker.ore.control.impl.v26_1_base.placement;
...
public abstract class MinecraftPlacementModifierHook<M extends PlacementModifier,
        C extends PlacementModifierConfiguration>
        extends PlacementModifier implements PlacementModifierHook<C> {
    ...
    public MinecraftPlacementModifierHook(
            @NotNull OreControlManager oreControlManager,
            @NotNull String name,
            @NotNull M defaultModifier,
            @NotNull Biome biome,
            @NotNull NamespacedKey namespacedKey) {
        this.configManager = oreControlManager.getConfigManager();
        this.placementModifier = (FeaturePlacementModifier<C>) oreControlManager
                .getRegistries()
    ...
    public abstract M createModifier(
            @NotNull C defaultConfiguration,
    ...
    public Stream<BlockPos> getPositions(PlacementContext context, RandomSource random, BlockPos blockPos) {
        PlacementModifierConfiguration configuration = cache.computeIfAbsent(
                context
                        .getLevel()
                        .getMinecraftWorld()
                        .getWorld()
        ...
        if (configuration != null) {
            ...
            modifier = createModifier(
                    ...
                    new BlockVector(blockPos.getX(), blockPos.getY(), blockPos.getZ()),
                    limitedRegion,
                    (C) configuration);
    ...
    private Stream<BlockPos> getPositions(
            Optional<PlacedFeature> top,
            WorldGenLevel world,
